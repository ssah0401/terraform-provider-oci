...
var (
	...
	webAppFirewallPolicyRepresentation = map[string]interface{}{
		"compartment_id":          acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"actions":                 acctest.RepresentationGroup{RepType: acctest.Optional, Group: webAppFirewallPolicyActionsRepresentation},
		...
		"response_protection":     acctest.RepresentationGroup{RepType: acctest.Optional, Group: webAppFirewallPolicyResponseProtectionRepresentation},
	...
	webAppFirewallPolicyActionsRepresentation = map[string]interface{}{
		"name":    acctest.Representation{RepType: acctest.Required, Create: `name`, Update: `name2`},
		"type":    acctest.Representation{RepType: acctest.Required, Create: `CHECK`, Update: `ALLOW`},
	...
	webAppFirewallPolicyRequestAccessControlRepresentation = map[string]interface{}{
		"default_action_name": acctest.Representation{RepType: acctest.Required, Create: `defaultActionName`, Update: `defaultActionName2`},
	...
	webAppFirewallPolicyRequestProtectionRulesProtectionCapabilitySettingsRepresentation = map[string]interface{}{
		"allowed_http_methods":           acctest.Representation{RepType: acctest.Optional, Create: []string{`allowedHttpMethods`}, Update: []string{`allowedHttpMethods2`}},
	...
	WebAppFirewallPolicyResourceDependencies = DefinedTagsDependencies
)
	...
	acctest.ResourceTest(t, testAccCheckWafWebAppFirewallPolicyDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "actions.0.code", "10"),
				...
				resource.TestCheckResourceAttr(resourceName, "actions.0.name", "name"),
				resource.TestCheckResourceAttr(resourceName, "actions.0.type", "CHECK"),
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "display_name", "displayName"),
				resource.TestCheckResourceAttr(resourceName, "freeform_tags.%", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "id"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.0.default_action_name", "defaultActionName"),
				...
				resource.TestCheckResourceAttr(resourceName, "request_access_control.0.rules.0.condition", "condition"),
				...
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.condition", "condition"),
				...
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.action_name", "actionName"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_action_threshold", "10"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_weights.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_weights.0.key", "key"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_weights.0.weight", "10"),
				...
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.key", "key"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.version", "10"),
				...
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.type", "ACCESS_CONTROL"),
				...
				resource.TestCheckResourceAttr(resourceName, "request_rate_limiting.0.rules.0.condition", "condition"),
				...
				resource.TestCheckResourceAttr(resourceName, "request_rate_limiting.0.rules.0.type", "ACCESS_CONTROL"),
				...
				resource.TestCheckResourceAttr(resourceName, "response_access_control.0.rules.0.condition", "condition"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "actions.0.body.0.type", "STATIC_TEXT"),
				resource.TestCheckResourceAttr(resourceName, "actions.0.code", "11"),
				resource.TestCheckResourceAttr(resourceName, "actions.0.headers.#", "1"),
				...
				resource.TestCheckResourceAttr(resourceName, "actions.0.name", "name2"),
				resource.TestCheckResourceAttr(resourceName, "actions.0.type", "ALLOW"),
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "display_name", "displayName2"),
				resource.TestCheckResourceAttr(resourceName, "freeform_tags.%", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "id"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.0.default_action_name", "defaultActionName2"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.0.rules.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.0.rules.0.action_name", "actionName2"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.0.rules.0.condition", "condition2"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.0.rules.0.condition_language", "JMESPATH"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.0.rules.0.name", "name2"),
				resource.TestCheckResourceAttr(resourceName, "request_access_control.0.rules.0.type", "PROTECTION"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.action_name", "actionName2"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.condition", "condition2"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.condition_language", "JMESPATH"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.name", "name2"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.action_name", "actionName2"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_action_threshold", "11"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_weights.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_weights.0.key", "key2"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_weights.0.weight", "11"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.exclusions.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.exclusions.0.args.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.exclusions.0.request_cookies.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.key", "key2"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capabilities.0.version", "11"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capability_settings.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.rules.0.protection_capability_settings.0.allowed_http_methods.#", "1"),
				...
				resource.TestCheckResourceAttr(resourceName, "request_rate_limiting.0.rules.0.condition", "condition2"),
				resource.TestCheckResourceAttr(resourceName, "request_rate_limiting.0.rules.0.condition_language", "JMESPATH"),
				resource.TestCheckResourceAttr(resourceName, "request_rate_limiting.0.rules.0.configurations.#", "1"),
				...
				resource.TestCheckResourceAttr(resourceName, "request_rate_limiting.0.rules.0.type", "PROTECTION"),
				resource.TestCheckResourceAttr(resourceName, "response_access_control.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "response_access_control.0.rules.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "response_access_control.0.rules.0.action_name", "actionName2"),
				resource.TestCheckResourceAttr(resourceName, "response_access_control.0.rules.0.condition", "condition2"),
				resource.TestCheckResourceAttr(resourceName, "response_access_control.0.rules.0.condition_language", "JMESPATH"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "actions.0.code", "11"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "actions.0.name", "name2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "actions.0.type", "ALLOW"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "request_access_control.0.default_action_name", "defaultActionName2"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "request_access_control.0.rules.0.condition", "condition2"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "request_access_control.0.rules.0.type", "PROTECTION"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "request_protection.0.rules.0.condition", "condition2"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "request_protection.0.rules.0.protection_capabilities.0.action_name", "actionName2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_action_threshold", "11"),
				resource.TestCheckResourceAttr(singularDatasourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_weights.#", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_weights.0.key", "key2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "request_protection.0.rules.0.protection_capabilities.0.collaborative_weights.0.weight", "11"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "request_protection.0.rules.0.protection_capabilities.0.key", "key2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "request_protection.0.rules.0.protection_capabilities.0.version", "11"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "request_rate_limiting.0.rules.0.condition", "condition2"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "request_rate_limiting.0.rules.0.type", "PROTECTION"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "response_access_control.0.rules.0.condition", "condition2"),
...
func getWebAppFirewallPolicyIds(compartment string) ([]string, error) {
	...
	listWebAppFirewallPoliciesRequest.LifecycleState = oci_waf.ListWebAppFirewallPoliciesLifecycleStateActive
